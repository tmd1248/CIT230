...
var requestURL = "https://api.openweathermap.org/data/2.5/forecast?id=4580543&units=imperial&APPID=01e2cf1ac0f55acf5118804f391b2be5";
var i
...
weatherRequest.onload = function() {
    ...
    if (weatherData.list[0].rain != null) {document.getElementById("precipSpan").innerHTML=weatherData.list[0].rain["3h"]} else {document.getElementById("precipSpan").innerHTML="0"};
